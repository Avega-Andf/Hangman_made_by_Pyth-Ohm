...
#
## En este repositorio, se presenta el desarrollo y la realización del juego de ahorcado en Python,  con opciones de idioma , multijugador y grado de dificultad .
# Bibliotecas
##### Import random
...
print("Seleccione la dificultad deseada...\n"+" 1.facil \n"+" 2.normal \n"+" 3.dificil ")
        dif=int(input(""))
```
Esta parte del codigo se encuentra en la funcion de interfaz que se mostrara mas adelante. 
<br>
